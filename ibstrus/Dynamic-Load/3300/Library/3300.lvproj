...
<Project Type="Project" LVVersion="19008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Documents" Type="Folder">
			<Item Name="Keysight N330X Programming Guide.pdf" Type="Document" URL="../../Documentation/Keysight N330X Programming Guide.pdf"/>
		</Item>
		<Item Name="3300.lvlib" Type="Library" URL="../3300.lvlib"/>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="instr.lib" Type="Folder">
				<Item Name="Agilent N330X Series.lvlib" Type="Library" URL="/&lt;instrlib&gt;/Agilent N330X Series/Agilent N330X Series.lvlib"/>
			</Item>
			...
			<Item Name="Electronic Load.lvlibp" Type="LVLibp" URL="../../../../builds/Instruments/Electronic Load.lvlibp">
				<Item Name="Messages" Type="Folder">
					<Item Name="Protection" Type="Folder">
						<Item Name="Write OCP Delay Msg.lvclass" Type="LVClass" URL="../../../../builds/Instruments/Electronic Load.lvlibp/Electronic Load Messages/Write OCP Delay Msg/Write OCP Delay Msg.lvclass"/>
						<Item Name="Write OCP Enable Msg.lvclass" Type="LVClass" URL="../../../../builds/Instruments/Electronic Load.lvlibp/Electronic Load Messages/Write OCP Enable Msg/Write OCP Enable Msg.lvclass"/>
						<Item Name="Write OCP Level Msg.lvclass" Type="LVClass" URL="../../../../builds/Instruments/Electronic Load.lvlibp/Electronic Load Messages/Write OCP Level Msg/Write OCP Level Msg.lvclass"/>
					</Item>
					<Item Name="Settings" Type="Folder">
						<Item Name="Write Active Channel Msg.lvclass" Type="LVClass" URL="../../../../builds/Instruments/Electronic Load.lvlibp/Electronic Load Messages/Write Active Channel Msg/Write Active Channel Msg.lvclass"/>
						<Item Name="Write Input Level Msg.lvclass" Type="LVClass" URL="../../../../builds/Instruments/Electronic Load.lvlibp/Electronic Load Messages/Write Input Level Msg/Write Input Level Msg.lvclass"/>
						<Item Name="Write Mode Msg.lvclass" Type="LVClass" URL="../../../../builds/Instruments/Electronic Load.lvlibp/Electronic Load Messages/Write Mode Msg/Write Mode Msg.lvclass"/>
						<Item Name="Write Output Enable Msg.lvclass" Type="LVClass" URL="../../../../builds/Instruments/Electronic Load.lvlibp/Electronic Load Messages/Write Output Enable Msg/Write Output Enable Msg.lvclass"/>
						<Item Name="Write Slew Rate Msg.lvclass" Type="LVClass" URL="../../../../builds/Instruments/Electronic Load.lvlibp/Electronic Load Messages/Write Slew Rate Msg/Write Slew Rate Msg.lvclass"/>
					</Item>
					<Item Name="Triggering" Type="Folder">
						<Item Name="Write All Pulse Msg.lvclass" Type="LVClass" URL="../../../../builds/Instruments/Electronic Load.lvlibp/Electronic Load Messages/Write All Pulse Msg/Write All Pulse Msg.lvclass"/>
						<Item Name="Write Pulse Data Points Msg.lvclass" Type="LVClass" URL="../../../../builds/Instruments/Electronic Load.lvlibp/Electronic Load Messages/Write Pulse Data Points Msg/Write Pulse Data Points Msg.lvclass"/>
						<Item Name="Write Pulse Delay Msg.lvclass" Type="LVClass" URL="../../../../builds/Instruments/Electronic Load.lvlibp/Electronic Load Messages/Write Pulse Delay Msg/Write Pulse Delay Msg.lvclass"/>
						<Item Name="Write Pulse Enable Msg.lvclass" Type="LVClass" URL="../../../../builds/Instruments/Electronic Load.lvlibp/Electronic Load Messages/Write Pulse Enable Msg/Write Pulse Enable Msg.lvclass"/>
						<Item Name="Write Pulse Initial Msg.lvclass" Type="LVClass" URL="../../../../builds/Instruments/Electronic Load.lvlibp/Electronic Load Messages/Write Pulse Initial Msg/Write Pulse Initial Msg.lvclass"/>
						<Item Name="Write Pulse Mode Msg.lvclass" Type="LVClass" URL="../../../../builds/Instruments/Electronic Load.lvlibp/Electronic Load Messages/Write Pulse Mode Msg/Write Pulse Mode Msg.lvclass"/>
						<Item Name="Write Pulse Sample Interval Msg.lvclass" Type="LVClass" URL="../../../../builds/Instruments/Electronic Load.lvlibp/Electronic Load Messages/Write Pulse Sample Interval Msg/Write Pulse Sample Interval Msg.lvclass"/>
						<Item Name="Write Pulse Slew Msg.lvclass" Type="LVClass" URL="../../../../builds/Instruments/Electronic Load.lvlibp/Electronic Load Messages/Write Pulse Slew Msg/Write Pulse Slew Msg.lvclass"/>
						<Item Name="Write Pulse Width Msg.lvclass" Type="LVClass" URL="../../../../builds/Instruments/Electronic Load.lvlibp/Electronic Load Messages/Write Pulse Width Msg/Write Pulse Width Msg.lvclass"/>
						<Item Name="Write Transient Msg.lvclass" Type="LVClass" URL="../../../../builds/Instruments/Electronic Load.lvlibp/Electronic Load Messages/Write Transient Msg/Write Transient Msg.lvclass"/>
					</Item>
					<Item Name="Reset Eload Msg.lvclass" Type="LVClass" URL="../../../../builds/Instruments/Electronic Load.lvlibp/Electronic Load Messages/Reset Eload Msg/Reset Eload Msg.lvclass"/>
				</Item>
				<Item Name="Electronic Load.lvclass" Type="LVClass" URL="../../../../builds/Instruments/Electronic Load.lvlibp/Library/Electronic Load.lvclass"/>
			</Item>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="3300" Type="Packed Library">
				<Property Name="Bld_autoIncrement" Type="Bool">true</Property>
				<Property Name="Bld_buildCacheID" Type="Str">{48482A64-8E58-459F-A04D-3B7609CCF66E}</Property>
				<Property Name="Bld_buildSpecName" Type="Str">3300</Property>
				...
				<Property Name="Bld_previewCacheID" Type="Str">{B5EC0A6B-F523-41AA-AF62-345AFD92D94E}</Property>
				<Property Name="Bld_version.build" Type="Int">1</Property>
				<Property Name="Bld_version.major" Type="Int">3</Property>
				<Property Name="Destination[0].destName" Type="Str">3300.lvlibp</Property>
				...
				<Property Name="Source[0].itemID" Type="Str">{92892DE3-E491-47C3-BB01-7498F83E6543}</Property>
				<Property Name="Source[0].type" Type="Str">Container</Property>
				<Property Name="Source[1].destinationIndex" Type="Int">0</Property>
				<Property Name="Source[1].itemID" Type="Ref">/My Computer/3300.lvlib</Property>
...
v0.2.0.7 - updated Dialog Trigger Settings UI - Enforced trigger delay limits
v0.2.0.6 - Refactored to use new class terms
v0.2.0.5 - Removed Transient and Trigger Levels from Std Testing
v0.2.0.4 - Added 3300 range coercion for trigger and transient settings
v0.2.0.3 - Added 3300 automatic range selection
v0.2.0.2 - Modified Measurement routine to accelerate measurement process.
v2.0.0.0 - Updated to LV 2019- Enable PPL access for future LV versions
V1.1.0.1 - Updated ELoad Libraries to resolve bugs and add Pulse Routine 
V1.1.0.0 - Updated to LV 2017
V1.0.0.0 - Initial Release</Property>
				<Property Name="TgtF_internalName" Type="Str">3300</Property>
				<Property Name="TgtF_legalCopyright" Type="Str">Copyright © 2019 JPL</Property>
				<Property Name="TgtF_productName" Type="Str">3300</Property>
				<Property Name="TgtF_targetfileGUID" Type="Str">{D85EB274-8FC5-4135-9C0F-E60A5E8EF945}</Property>
				<Property Name="TgtF_targetfileName" Type="Str">3300.lvlibp</Property>
