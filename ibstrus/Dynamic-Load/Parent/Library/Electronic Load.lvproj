...
<Project Type="Project" LVVersion="19008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Electronic Load.lvlib" Type="Library" URL="../Electronic Load.lvlib"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Electronic Load" Type="Packed Library">
				<Property Name="Bld_autoIncrement" Type="Bool">true</Property>
				<Property Name="Bld_buildCacheID" Type="Str">{FFA0FEFE-0449-4F74-BB53-01A18924ACAF}</Property>
				<Property Name="Bld_buildSpecDescription" Type="Str">Electronic Load Packed Project Library
Author:  Ronald Dexter
Date:  7/8/2019</Property>
				<Property Name="Bld_buildSpecName" Type="Str">Electronic Load</Property>
				...
				<Property Name="Bld_previewCacheID" Type="Str">{77AFF0FE-48B5-4D8C-AE81-DD5D70CF0D4D}</Property>
				<Property Name="Bld_version.build" Type="Int">1</Property>
				<Property Name="Bld_version.major" Type="Int">3</Property>
				<Property Name="Destination[0].destName" Type="Str">Electronic Load.lvlibp</Property>
				...
				<Property Name="Source[0].itemID" Type="Str">{931073DA-E73C-4D06-8D73-60D44C938533}</Property>
				<Property Name="Source[0].type" Type="Str">Container</Property>
				<Property Name="Source[1].destinationIndex" Type="Int">0</Property>
				<Property Name="Source[1].itemID" Type="Ref">/My Computer/Electronic Load.lvlib</Property>
...
v2.0.0.9 - Refactor for Base 3.0
v2.0.0.8 - Resolved Eload GUI Startup - Now the continuous display is the initial display.
v2.0.0.7 - Embedded ELoad GUI
v2.0.0.6 - Modified Channel Enum to be useable in TestStand
v2.0.0.5 - Added Slew Rate
v2.0.0.4 - Updated Class Inheritance
v2.0.0.3 - Added Channel Details accessors &amp; Measure All Override
v2.0.0.2 - Updated Class to have array based controls
v2.0.0.1 - Added Override Dialog Trigger Settings
v2.0.0.0 - Updated to LV 2019- Enable PPL access for future LV versions
v1.1.0.7 - Updated Measure Channels - Now measuring channels at all times.
v1.1.0.6 - Integrated new function typedef *** Note:  May need to review send methods 
v1.1.0.5 - Added Send Custom Control.  Created Send Settings Implementations
v1.1.0.4 - Integrated Pulse Data Acquisition tools &amp; Accessors.
V1.1.0.3 - Added Read Device Accessor
V1.1.0.2 - Updated Trigger settings to appropriate data types (dbl, int, etc)
V1.1.0.1 - Added trigger configuration utilities
V1.1.0.0 - Updated to LV 2017
V1.0.0.3: Updated Self Test, Added Number of Channels Accessor, implemented connect routine in initialization.
V1.0.0.2:  Updated self test documentation and form
V1.0.0.1:  Added Trigger Timestamp on triggering Override Function
V1.0.0.0: Initial Release</Property>
				<Property Name="TgtF_internalName" Type="Str">Electronic Load</Property>
				<Property Name="TgtF_legalCopyright" Type="Str">Copyright © 2019 JPL</Property>
				<Property Name="TgtF_productName" Type="Str">Electronic Load</Property>
				<Property Name="TgtF_targetfileGUID" Type="Str">{4B6020E8-E097-4A0E-893C-A72D6561DE9B}</Property>
				<Property Name="TgtF_targetfileName" Type="Str">Electronic Load.lvlibp</Property>
