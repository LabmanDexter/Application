...
<Project Type="Project" LVVersion="19008000">
	...
	<Item Name="My Computer" Type="My Computer">
		<Property Name="AF.PPL" Type="Path">/C/Users/Public/Documents/Development/builds/Engine/Actor Framework.lvlibp</Property>
		...
		<Item Name="PowerSupply.lvlib" Type="Library" URL="../PowerSupply.lvlib"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="PowerSupply" Type="Packed Library">
				<Property Name="Bld_autoIncrement" Type="Bool">true</Property>
				<Property Name="Bld_buildCacheID" Type="Str">{FE7C5F1A-4558-40F1-BC35-FBF4ADDDF39A}</Property>
				<Property Name="Bld_buildSpecDescription" Type="Str">Power Supply parent library.  All tests should use this module to control the power supply.  Child classes will perform the device specific functions, but all power supply controls should be managed at this level.  

Note:  If a child class is not capable of performing a specific function, a warning message should be created.  This is so that if a supply is swapped out for calibration reasons and the supply installed doesn't support the functionality, a warning will be presented so the developer/operator can address the issue prior to testing.</Property>
				<Property Name="Bld_buildSpecName" Type="Str">PowerSupply</Property>
				...
				<Property Name="Bld_previewCacheID" Type="Str">{7BF34DA7-FC18-4B08-973F-D3CBF887C235}</Property>
				<Property Name="Bld_version.build" Type="Int">1</Property>
				<Property Name="Bld_version.major" Type="Int">3</Property>
				<Property Name="Destination[0].destName" Type="Str">PowerSupply.lvlibp</Property>
				...
				<Property Name="Source[0].itemID" Type="Str">{F2E8284C-6AA2-4EED-99BE-4267EBAD6EDA}</Property>
				<Property Name="Source[0].type" Type="Str">Container</Property>
				<Property Name="Source[1].destinationIndex" Type="Int">0</Property>
				<Property Name="Source[1].itemID" Type="Ref">/My Computer/PowerSupply.lvlib</Property>
...
v3.0.0.0 - Release Staging.
v2.0.1.3 - Updated Shutdown routine to force power off.
v2.0.0.0 - Refactor for Base 3.0
v0.2.2.3 - Added Local Sense Point Accessors
v0.2.2.2 - Added Channel Naming tool
v0.2.2.1 - Added Foldback/Shutdown OCP Behavior Modes
v0.2.2.0 - Modified GUI to be re-entrant - Modified GUI to show front panel
v0.2.1.5 - Merged Updates from Released branch
v0.2.1.4 - Added Is UUT Supply Flag Supporting future Chronometer tools
v0.2.1.3 - Created Override Create Channel Names &amp; Scripting Init tools
v0.2.1.2 - Added tool to query poll rate for power supplies
v0.2.1.1 - Added data to waveform generic manipulator
v0.2.1.0 - added Get Number of Channels Override VI.
v0.2.0.1 - Added current and voltage limit validation overrides
v2.0.0.0 - Updated to LV 2019- Enable PPL access for future LV versions
v1.1.0.5 - Initial Build, overhaul to getters &amp; Setters
v1.1.0.4 - Scaled Supply Library to support multiple BSS data points not originally accounted for.
v1.1.0.3 - Added Battery Efficiency accessors, expanded mode operation to include Battery &amp; Database
v1.1.0.2 - added spin mode qualifier - Added File Read/Write modes to sent query enums.
v1.1.0.1 - Expanded functionality to Support SAS - Added Current Ramp, Mode Select, New value selects for settings, and flow control override functionality.
v1.1.0.0 - Updated to LV 2017
v1.0.0.5 - Removed several unecessary functions, cleaned up programming, created setting/alarm bulk setting messages.
V1.0.0.4 - Modified Alarm Indicators, since they are alarm lights, changed the on state to RED
V1.0.0.3 - Added OCP Setpoint Configuration, Moved files to more appropriate directories for development purposes. Added Ramp Rate configuration, Added Self Test Override.  Updated Controls &amp; Indicators to Silver Controls &amp; Indicators per programming specifications.
V1.0.0.0 - Initial release.  Added functionality, created ambiguation between setpoint setters &amp; and writers.
V0.0.0.2 - Pre-release:  Still need added functionality of power supplies, and modification of read, write and set values.</Property>
				<Property Name="TgtF_internalName" Type="Str">PowerSupply</Property>
				<Property Name="TgtF_legalCopyright" Type="Str">Copyright © 2019 JPL</Property>
				<Property Name="TgtF_productName" Type="Str">PowerSupply</Property>
				<Property Name="TgtF_targetfileGUID" Type="Str">{07860A41-D5D6-4591-AAFA-5BE8ABCD62AD}</Property>
				<Property Name="TgtF_targetfileName" Type="Str">PowerSupply.lvlibp</Property>
