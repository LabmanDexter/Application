...
<Project Type="Project" LVVersion="19008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="DIG_IO.lvlib" Type="Library" URL="../DIG_IO.lvlib"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Dig_IO" Type="Packed Library">
				<Property Name="Bld_autoIncrement" Type="Bool">true</Property>
				<Property Name="Bld_buildCacheID" Type="Str">{83C8803D-719D-480F-87AC-ED9C2D99DCF2}</Property>
				<Property Name="Bld_buildSpecDescription" Type="Str">This is the parent library for Digital IO modules.  It provides the abstraction layer for the code development.  

Child class methods should instantiate the appropriate read &amp; write utilities for the specific digital IO module.</Property>
				<Property Name="Bld_buildSpecName" Type="Str">Dig_IO</Property>
				...
				<Property Name="Bld_previewCacheID" Type="Str">{1EE9D861-2B29-46B3-A119-0B2B90509C4E}</Property>
				<Property Name="Bld_version.build" Type="Int">1</Property>
				<Property Name="Bld_version.major" Type="Int">3</Property>
				<Property Name="Destination[0].destName" Type="Str">DIG_IO.lvlibp</Property>
				...
				<Property Name="Source[0].itemID" Type="Str">{969F11B3-59BC-4F63-9239-A646F82743D2}</Property>
				<Property Name="Source[0].type" Type="Str">Container</Property>
				<Property Name="Source[1].destinationIndex" Type="Int">0</Property>
				<Property Name="Source[1].itemID" Type="Ref">/My Computer/DIG_IO.lvlib</Property>
...
v0.3.0.0 - Re-build with Auto-Logging Features
v0.2.0.6 - Added Pulse Switch Output Routine
v0.2.0.5 - Full build with Event and status logging
v0.2.0.4 - Added Accessors for Input and output counts
v0.2.0.3 - Added XOR Rule Safety check 
v0.2.0.2 - Added Scripting Initialize
v0.2.0.1 - Updated Versioning
v2.0.0.1 - Apply Signal Names
v2.0.0.0 - Updated to LV 2019- Enable PPL access for future LV versions
V1.1.0.2 - Added Digital In and Digital Out signal Names Arrays, accessors, and config utilities
v1.1.0.1 - Added device accessor 
V1.1.0.0 - Updated to LV 2017
V1.0.0.2 - Added error checking to prevent array extension of the digital output array
V1.0.0.1 - Released with more comments and documentation.  **Note:  may need to add synchronization option
V1.0.0.0 - Initial release.</Property>
				<Property Name="TgtF_internalName" Type="Str">Dig_IO</Property>
				<Property Name="TgtF_legalCopyright" Type="Str">Copyright © 2019 JPL</Property>
				<Property Name="TgtF_productName" Type="Str">Dig_IO</Property>
				<Property Name="TgtF_targetfileGUID" Type="Str">{6EA21190-8906-4B11-9D90-99846A316D3E}</Property>
				<Property Name="TgtF_targetfileName" Type="Str">DIG_IO.lvlibp</Property>
