	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Docking.lvlibp" Type="LVLibp" URL="../../../../builds/Main/Docking.lvlibp">
				...
				<Item Name="BottomDock.lvclass" Type="LVClass" URL="../../../../builds/Main/Docking.lvlibp/Bottom Panel/BottomDock.lvclass"/>
				<Item Name="Docking.lvclass" Type="LVClass" URL="../../../../builds/Main/Docking.lvlibp/Docking/Docking.lvclass"/>
				<Item Name="PrimeDock.lvclass" Type="LVClass" URL="../../../../builds/Main/Docking.lvlibp/Prime Panel/PrimeDock.lvclass"/>
				<Item Name="RightDock.lvclass" Type="LVClass" URL="../../../../builds/Main/Docking.lvlibp/Right Panel/RightDock.lvclass"/>
			</Item>
			<Item Name="EmbedImage.lvlibp" Type="LVLibp" URL="../../../../builds/Tools/EmbedImage.lvlibp">
				<Item Name="Bit-array To Byte-array.vi" Type="VI" URL="../../../../builds/Tools/EmbedImage.lvlibp/1abvi3w/vi.lib/picture/pictutil.llb/Bit-array To Byte-array.vi"/>
				<Item Name="Calc Long Word Padded Width.vi" Type="VI" URL="../../../../builds/Tools/EmbedImage.lvlibp/1abvi3w/vi.lib/picture/bmp.llb/Calc Long Word Padded Width.vi"/>
				<Item Name="Check if File or Folder Exists.vi" Type="VI" URL="../../../../builds/Tools/EmbedImage.lvlibp/1abvi3w/vi.lib/Utility/libraryn.llb/Check if File or Folder Exists.vi"/>
				<Item Name="Check Path.vi" Type="VI" URL="../../../../builds/Tools/EmbedImage.lvlibp/1abvi3w/vi.lib/picture/jpeg.llb/Check Path.vi"/>
				<Item Name="Create Mask By Alpha.vi" Type="VI" URL="../../../../builds/Tools/EmbedImage.lvlibp/1abvi3w/vi.lib/picture/picture.llb/Create Mask By Alpha.vi"/>
				<Item Name="Directory of Top Level VI.vi" Type="VI" URL="../../../../builds/Tools/EmbedImage.lvlibp/1abvi3w/vi.lib/picture/jpeg.llb/Directory of Top Level VI.vi"/>
				<Item Name="Draw Flattened Pixmap.vi" Type="VI" URL="../../../../builds/Tools/EmbedImage.lvlibp/1abvi3w/vi.lib/picture/picture.llb/Draw Flattened Pixmap.vi"/>
				<Item Name="EmbedImage.lvclass" Type="LVClass" URL="../../../../builds/Tools/EmbedImage.lvlibp/Library/EmbedImage.lvclass"/>
				<Item Name="Error Cluster From Error Code.vi" Type="VI" URL="../../../../builds/Tools/EmbedImage.lvlibp/1abvi3w/vi.lib/Utility/error.llb/Error Cluster From Error Code.vi"/>
				<Item Name="FixBadRect.vi" Type="VI" URL="../../../../builds/Tools/EmbedImage.lvlibp/1abvi3w/vi.lib/picture/pictutil.llb/FixBadRect.vi"/>
				<Item Name="Flip and Pad for Picture Control.vi" Type="VI" URL="../../../../builds/Tools/EmbedImage.lvlibp/1abvi3w/vi.lib/picture/bmp.llb/Flip and Pad for Picture Control.vi"/>
				<Item Name="imagedata.ctl" Type="VI" URL="../../../../builds/Tools/EmbedImage.lvlibp/1abvi3w/vi.lib/picture/picture.llb/imagedata.ctl"/>
				<Item Name="NI_FileType.lvlib" Type="Library" URL="../../../../builds/Tools/EmbedImage.lvlibp/1abvi3w/vi.lib/Utility/lvfile.llb/NI_FileType.lvlib"/>
				<Item Name="NI_PackedLibraryUtility.lvlib" Type="Library" URL="../../../../builds/Tools/EmbedImage.lvlibp/1abvi3w/vi.lib/Utility/LVLibp/NI_PackedLibraryUtility.lvlib"/>
				<Item Name="Read BMP File Data.vi" Type="VI" URL="../../../../builds/Tools/EmbedImage.lvlibp/1abvi3w/vi.lib/picture/bmp.llb/Read BMP File Data.vi"/>
				<Item Name="Read BMP File.vi" Type="VI" URL="../../../../builds/Tools/EmbedImage.lvlibp/1abvi3w/vi.lib/picture/bmp.llb/Read BMP File.vi"/>
				<Item Name="Read BMP Header Info.vi" Type="VI" URL="../../../../builds/Tools/EmbedImage.lvlibp/1abvi3w/vi.lib/picture/bmp.llb/Read BMP Header Info.vi"/>
				<Item Name="Read JPEG File.vi" Type="VI" URL="../../../../builds/Tools/EmbedImage.lvlibp/1abvi3w/vi.lib/picture/jpeg.llb/Read JPEG File.vi"/>
				<Item Name="Read PNG File.vi" Type="VI" URL="../../../../builds/Tools/EmbedImage.lvlibp/1abvi3w/vi.lib/picture/png.llb/Read PNG File.vi"/>
			</Item>
			...
			<Item Name="Fault Monitor.lvlibp" Type="LVLibp" URL="../../../../builds/Main/Fault Monitor.lvlibp">
				<Item Name="Messages" Type="Folder">
					<Item Name="Clear Target Faults Msg.lvclass" Type="LVClass" URL="../../../../builds/Main/Fault Monitor.lvlibp/Fault Monitor Messages/Clear Target Faults Msg/Clear Target Faults Msg.lvclass"/>
					<Item Name="Handle Faults Msg.lvclass" Type="LVClass" URL="../../../../builds/Main/Fault Monitor.lvlibp/Fault Monitor Messages/Handle Faults Msg/Handle Faults Msg.lvclass"/>
				</Item>
				<Item Name="Fault Monitor.lvclass" Type="LVClass" URL="../../../../builds/Main/Fault Monitor.lvlibp/Library/Fault Monitor.lvclass"/>
			...
			<Item Name="Main.lvlibp" Type="LVLibp" URL="../../../../builds/Main/Main.lvlibp">
				<Item Name="Messages" Type="Folder">
					<Item Name="Menu Response Msg.lvclass" Type="LVClass" URL="../../../../builds/Main/Main.lvlibp/Main Messages/Menu Response Msg/Menu Response Msg.lvclass"/>
					<Item Name="Toggle Component Display Msg.lvclass" Type="LVClass" URL="../../../../builds/Main/Main.lvlibp/Main Messages/Toggle Component Display Msg/Toggle Component Display Msg.lvclass"/>
				</Item>
				<Item Name="Launch Main.vi" Type="VI" URL="../../../../builds/Main/Main.lvlibp/Launch Main.vi"/>
				<Item Name="Main.lvclass" Type="LVClass" URL="../../../../builds/Main/Main.lvlibp/Library/Main.lvclass"/>
			</Item>
			...
			<Item Name="ReportGenerator.lvlibp" Type="LVLibp" URL="../../../../builds/Main/ReportGenerator.lvlibp">
				<Item Name="Messages" Type="Folder">
					<Item Name="Periodically Flush Queue Msg.lvclass" Type="LVClass" URL="../../../../builds/Main/ReportGenerator.lvlibp/Report Generator Messages/Periodically Flush Queue Msg/Periodically Flush Queue Msg.lvclass"/>
					<Item Name="Toggle Report Open Close Msg.lvclass" Type="LVClass" URL="../../../../builds/Main/ReportGenerator.lvlibp/Report Generator Messages/Toggle Report Open Close Msg/Toggle Report Open Close Msg.lvclass"/>
				</Item>
				<Item Name="Check if File or Folder Exists.vi" Type="VI" URL="../../../../builds/Main/ReportGenerator.lvlibp/1abvi3w/vi.lib/Utility/libraryn.llb/Check if File or Folder Exists.vi"/>
				<Item Name="Dflt Data Dir.vi" Type="VI" URL="../../../../builds/Main/ReportGenerator.lvlibp/1abvi3w/vi.lib/Utility/file.llb/Dflt Data Dir.vi"/>
				<Item Name="Error Cluster From Error Code.vi" Type="VI" URL="../../../../builds/Main/ReportGenerator.lvlibp/1abvi3w/vi.lib/Utility/error.llb/Error Cluster From Error Code.vi"/>
				<Item Name="NI_FileType.lvlib" Type="Library" URL="../../../../builds/Main/ReportGenerator.lvlibp/1abvi3w/vi.lib/Utility/lvfile.llb/NI_FileType.lvlib"/>
				<Item Name="NI_PackedLibraryUtility.lvlib" Type="Library" URL="../../../../builds/Main/ReportGenerator.lvlibp/1abvi3w/vi.lib/Utility/LVLibp/NI_PackedLibraryUtility.lvlib"/>
				<Item Name="Report Generator.lvclass" Type="LVClass" URL="../../../../builds/Main/ReportGenerator.lvlibp/Library/Report Generator.lvclass"/>
			</Item>
			<Item Name="TDMS.lvlibp" Type="LVLibp" URL="../../../../builds/Tools/TDMS.lvlibp">
				<Item Name="TDMS.lvclass" Type="LVClass" URL="../../../../builds/Tools/TDMS.lvlibp/Library/TDMS.lvclass"/>
			</Item>
