	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Fault Handler" Type="Packed Library">
				...
				<Property Name="Source[0].itemID" Type="Str">{7ADBE716-BA78-4727-B7F3-B28E356FC8B1}</Property>
...
v0.0.0.1 - Pending formal Peer Review for Release to Revision 1
Author: Ronald Dexter
Company: JPL

Initial release of the Fault Handler library. </Property>
