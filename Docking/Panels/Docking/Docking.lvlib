...
<Library LVVersion="23008000">
	<Property Name="NI.Lib.Description" Type="Str">The Docking library provides the basic defintions for panel position, scale and adjustment methods.  

this library inherits from the managed actors to provide a means to manage subordinate classes if necessary.</Property>
	...
	<Item Name="Messages for Docking" Type="Folder">
		<Item Name="Adjust Splitter Msg.lvclass" Type="LVClass" URL="../../Docking Messages/Adjust Splitter Msg/Adjust Splitter Msg.lvclass"/>
	</Item>
	<Item Name="BottomDock.lvclass" Type="LVClass" URL="../../Bottom Panel/BottomDock.lvclass"/>
	<Item Name="Docking.lvclass" Type="LVClass" URL="../Docking.lvclass"/>
	<Item Name="PrimeDock.lvclass" Type="LVClass" URL="../../Prime Panel/PrimeDock.lvclass"/>
	<Item Name="RightDock.lvclass" Type="LVClass" URL="../../Right Panel/RightDock.lvclass"/>
</Library>
